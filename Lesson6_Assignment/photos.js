...
// add src to img elements based on order specified in photoOrder array
...
function previewFive() {
  ...
  //clone figure element for fifth image and edit
...
function createEventListeners() {
  ...
  if (leftarrow.addEventListener) {
    ...
    leftarow.attachEvent("onclick", leftArrow);
  }
